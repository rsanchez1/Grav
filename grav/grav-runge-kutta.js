...
function loadBodies(id) {
    ...
    switch (id) {
        ...
        case 9:
            ...
            globalOrigin = [500000, 300000];
            preset([
                {velocity: [0, -1426.20913134484878565427], position: [423913.45703234486238017826, 300000], radius: 6000, mass: 1.37174433e30, color: '#ff0'},
                {velocity: [0, 4863.56706001634398089323], position: [759465.45703234486238017826, 300000], radius: 2000, mass: 4.02255025e29, color: '#ff0'},
                {velocity: [0, 3701.88107120123905059218], position: [1554380, 300000], radius: 500, mass: 6.3199999999999368, color: '#fff'}
            ]);
            break;
        default:
            clearBodies();
